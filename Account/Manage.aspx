<%@ Page Title="Quản lý" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Manage.aspx.vb" Inherits="Account_Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section id="passwordForm">
        ...
        <p>Bạn đang đăng nhập với  <strong><%: User.Identity.Name %></strong>.</p>
                ...
                <ChangePasswordTemplate>
                    ...
                    <fieldset class="changePassword">
                        ...
                        <ol>
                            ...
                            <li>
                                <asp:Label runat="server" ID="ConfirmNewPasswordLabel" AssociatedControlID="ConfirmNewPassword">
                                Nhập lại mật khẩu
                                </asp:Label>
    ...
    <section id="externalLoginsForm">
        ...
        <asp:ListView runat="server"
            ...
            <LayoutTemplate>
                <h3>Đăng nhập và đăng kí ngoài</h3>
                <table>
                    <thead><tr><th>Dịch vụ</th><th>Tài khoản </th><th>Lần sử dụng trước </th><th>&nbsp;</th></tr></thead>
                    <tbody>
